"""
Train a FPR classifier model on a classification dataset.
...
from nodule_detection.models.frcnn import ClassificationModel, DetectionModel
...
def train(opt, device):
    """Trains a FPR model, managing datasets, model optimization, logging, and saving checkpoints."""
...
def run(**kwargs):
    """
    Executes FPR model training or inference with specified parameters, returning updated options.
